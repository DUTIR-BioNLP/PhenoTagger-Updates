...
def CNN_training(trainfiles,vocabfiles,modelfile,EPOCH=150):
    ...
    ontfiles={'dic_file':'../dict_19/noabb_lemma.dic',
              'word_hpo_file':'../dict_19/word_id_map.json',
              'hpo_word_file':'../dict_19/id_word_map.json'}
...
if __name__=="__main__":
    ...
    if args.modeltype=='cnn':
        vocabfiles={'w2vfile':'../models_v1.2/bio_embedding_intrinsic.d200',   
                    'charfile':'../dict_19/char.vocab',
                    'labelfile':'../dict_19/lable.vocab',
                    'posfile':'../dict_19/pos.vocab'}
        ...
        trainfiles['devout']=args.output+'cnn_dev_temp_19.tsv'
        modelfile=args.output+'cnn_PT_19.h5'
        CNN_training(trainfiles,vocabfiles,modelfile)
        
    elif args.modeltype=='bioformer':
        
        vocabfiles={'labelfile':'../dict_19/lable.vocab',
        ...
        trainfiles['trainfile']=args.trainfile
        trainfiles['devfile']=args.devfile
        trainfiles['devout']=args.output+'bioformer_dev_temp_19.tsv'
        modelfile=args.output+'bioformer-PT_19.h5'
        ...
        trainfiles['trainfile']=args.trainfile
        trainfiles['devfile']=args.devfile
        trainfiles['devout']=args.output+'pubmedbert_dev_temp_19.tsv'
        modelfile=args.output+'pubmedbert_PT_19.h5'
        BERT_training(trainfiles,vocabfiles,modelfile)
        ...
        trainfiles['trainfile']=args.trainfile
        trainfiles['devfile']=args.devfile
        trainfiles['devout']=args.output+'biobert_dev_temp_19.tsv'
        modelfile=args.output+'biobert-PT_19.h5'
        BERT_training(trainfiles,vocabfiles,modelfile)
