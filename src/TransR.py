...
def dataloader(file1, file2, file3, file4):
    ...
    with codecs.open(file1, 'r') as f:
        ...
        for line in content:
            ...
            # print(f'relation2id:{relations2id}')
    ...
    def training_run(self, epochs=300, batch_size=100, out_file_title = ''):
        ...
        for epoch in range(epochs):
            ...
            for batch in range(valid_batch):
                print(f'self.valid_triples = {self.valid_triples}, batch_size = {batch_size}')
...
if __name__ == '__main__':
    ...
    file1 = "./HPO_2024/train.txt"
    file2 = "./HPO_2024/entity2id.txt"
    file3 = "./HPO_2024/relation2id.txt"
    file4 = "./HPO_2024/valid.txt"
    ...
    file5 = "./transE_emb_2024/entity_512dim_batch400"
    file6 = "./transE_emb_2024/relation512dim_batch400"
    #
    transR = TransR_Training(entity_set, relation_set, triple_list, ent_dim=512, rel_dim=512, lr=0.001, margin=6.0,
                             norm=1, C=0.25,  valid_triples=valid_triple_list)
    # transR.data_initialise()
    transR.data_initialise(file5, file6)
    transR.training_run(epochs=1000, batch_size=400, out_file_title="transR_emb_2024/")
